...
export async function PUT(request: NextRequest) {
  try {
    ...
    const updateData: Record<string, unknown> = {
      ...
      videoBitrate: settingsData.videoBitrate ?? 1800,
      ...
      audioBitrate: settingsData.audioBitrate ?? 128,  // 128k default
      ...
      videoPid: settingsData.videoPid ?? 256,
      audioPid: settingsData.audioPid ?? 272,
      pmtPid: settingsData.pmtPid ?? 4096,
